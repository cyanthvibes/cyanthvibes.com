    ...
    <div class="py-4 px-3">
        ...
        <div class="intro px-3">
            <div class="profile-wrapper ">
                <img class="profile" id="profile" src="img/picture1.jpg" alt="">
            </div>
        </div>
        ...
        <div class="button-wrapper">
            <a href="https://discordapp.com/users/187286355435454466/" class="mb-3 btn btn-outline-primary d-flex flex-row btn-p discord">
                <div class="p-2 align-self-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="socials" viewBox="0 0 16 16">
                ...
                <div class="p-2 align-self-center btn-text">Cyan#9999</div>
            </a>

            <a href="https://instagram.com/cyanvibes"  class="my-3 btn btn-outline-primary d-flex flex-row btn-p instagram">
                <div class="p-2 align-self-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="socials" viewBox="0 0 16 16">
                ...
                <div class="p-2 align-self-center btn-text">cyanvibes</div>
            </a>

            <a href="https://facebook.com/cyanvibes" class="my-3 btn btn-outline-primary d-flex flex-row btn-p facebook">
                <div class="p-2 align-self-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="socials" viewBox="0 0 16 16">
            ...
            <a href="https://open.spotify.com/user/1117714078" class="my-3 btn btn-outline-primary d-flex flex-row btn-p spotify">
                <div class="p-2 align-self-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 496 512" class="socials">
                ...
                <div class="p-2 align-self-center btn-text">Harjan Redegeld</div>
            </a>

            <a href="https://www.twitch.tv/thatisabadkitty/" class="my-3 btn btn-outline-primary d-flex flex-row btn-p twitch">
                <div class="p-2 align-self-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="socials" viewBox="0 0 16 16">
                ...
                <div class="p-2 align-self-center btn-text">ThatIsABadKitty</div>
            </a>

            <a href="https://www.youtube.com/c/Cyan9999" class="my-3 btn btn-outline-primary d-flex flex-row btn-p youtube">
                <div class="p-2 align-self-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="socials" viewBox="0 0 16 16">
                ...
                <div class="p-2 align-self-center btn-text">Cyan</div>
            </a>

            <a href="https://snapchat.com/add/harjanredegeld" class="my-3 btn btn-outline-primary d-flex flex-row btn-p snapchat">
                <div class="p-2 align-self-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" class="socials">
                        <path fill="currentColor" d="M248 8C111 8 0 119 0 256s111 248 248 248 248-111 248-248S385 8 248 8zm169.5 338.9c-3.5 8.1-18.1 14-44.8 18.2-1.4 1.9-2.5 9.8-4.3 15.9-1.1 3.7-3.7 5.9-8.1 5.9h-.2c-6.2 0-12.8-2.9-25.8-2.9-17.6 0-23.7 4-37.4 13.7-14.5 10.3-28.4 19.1-49.2 18.2-21 1.6-38.6-11.2-48.5-18.2-13.8-9.7-19.8-13.7-37.4-13.7-12.5 0-20.4 3.1-25.8 3.1-5.4 0-7.5-3.3-8.3-6-1.8-6.1-2.9-14.1-4.3-16-13.8-2.1-44.8-7.5-45.5-21.4-.2-3.6 2.3-6.8 5.9-7.4 46.3-7.6 67.1-55.1 68-57.1 0-.1.1-.2.2-.3 2.5-5 3-9.2 1.6-12.5-3.4-7.9-17.9-10.7-24-13.2-15.8-6.2-18-13.4-17-18.3 1.6-8.5 14.4-13.8 21.9-10.3 5.9 2.8 11.2 4.2 15.7 4.2 3.3 0 5.5-.8 6.6-1.4-1.4-23.9-4.7-58 3.8-77.1C183.1 100 230.7 96 244.7 96c.6 0 6.1-.1 6.7-.1 34.7 0 68 17.8 84.3 54.3 8.5 19.1 5.2 53.1 3.8 77.1 1.1.6 2.9 1.3 5.7 1.4 4.3-.2 9.2-1.6 14.7-4.2 4-1.9 9.6-1.6 13.6 0 6.3 2.3 10.3 6.8 10.4 11.9.1 6.5-5.7 12.1-17.2 16.6-1.4.6-3.1 1.1-4.9 1.7-6.5 2.1-16.4 5.2-19 11.5-1.4 3.3-.8 7.5 1.6 12.5.1.1.1.2.2.3.9 2 21.7 49.5 68 57.1 4 1 7.1 5.5 4.9 10.8z" class=""></path>
                    </svg>
                </div>
                <div class="p-2 align-self-center btn-text">harjanredegeld</div>
            </a>

            <a href="https://github.com/cyanvibes" class="my-3 btn btn-outline-primary d-flex flex-row btn-p github">
                <div class="p-2 align-self-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="socials" viewBox="0 0 16 16">
            ...
            <a href="https://myanimelist.net/animelist/Cyanvibes" class="my-3 btn btn-outline-primary d-flex flex-row btn-p mal">
                <div class="p-2 align-self-center">
                    <svg xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 1000.000000 1000.000000"
                         class="socials" fill="currentColor">
            ...
            <a href="https://steamcommunity.com/id/cyanvibes/"  class="mt-3 btn btn-outline-primary d-flex flex-row btn-p steam">
                <div class="p-2 align-self-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" fill="currentColor" class="socials">
                        <path  d="M496 256c0 137-111.2 248-248.4 248-113.8 0-209.6-76.3-239-180.4l95.2 39.3c6.4 32.1 34.9 56.4 68.9 56.4 39.2 0 71.9-32.4 70.2-73.5l84.5-60.2c52.1 1.3 95.8-40.9 95.8-93.5 0-51.6-42-93.5-93.7-93.5s-93.7 42-93.7 93.5v1.2L176.6 279c-15.5-.9-30.7 3.4-43.5 12.1L0 236.1C10.2 108.4 117.1 8 247.6 8 384.8 8 496 119 496 256zM155.7 384.3l-30.5-12.6a52.79 52.79 0 0 0 27.2 25.8c26.9 11.2 57.8-1.6 69-28.4 5.4-13 5.5-27.3.1-40.3-5.4-13-15.5-23.2-28.5-28.6-12.9-5.4-26.7-5.2-38.9-.6l31.5 13c19.8 8.2 29.2 30.9 20.9 50.7-8.3 19.9-31 29.2-50.8 21zm173.8-129.9c-34.4 0-62.4-28-62.4-62.3s28-62.3 62.4-62.3 62.4 28 62.4 62.3-27.9 62.3-62.4 62.3zm.1-15.6c25.9 0 46.9-21 46.9-46.8 0-25.9-21-46.8-46.9-46.8s-46.9 21-46.9 46.8c.1 25.8 21.1 46.8 46.9 46.8z" class=""></path>
                    </svg>
                </div>
                <div class="p-2 align-self-center btn-text">Cyan</div>
            </a>
